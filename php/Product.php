...
function ProductDetailsLoggedIn($productname, $productprice, $productimg, $productid){
    $element = "
    
    <div class=\"\" id = \"PMain\">
        <form action = \"Product_details_LoggedIn.php?product=$productid\" method = \"POST\">
                <div class = \"float-left\" id = \"PImage\">
                    <img src = \"$productimg\" alt = \"Product1\" class = \"float-left\">
                </div>
                <div class = \"float-left\" id = \"PDesc\">
            ...
            <button id = \"BuyBtn\" type = \"submit\" name = \"Buy\" class = \"btn btn-primary my-3\">Add to cart</button> 
        </form>
    </div>
    <div id = \"Reviews\">
    <h5> Reviews </h5>
...
function ProductLoggedIn($productname, $productprice, $productimg, $productid){
    $element = "
...
function ProductAdmin($productname, $productprice, $productimg, $productid){
    $element = "
    
    <div class=\"col-lg-4 mb-3 flex-d align-items-stretch\">
        <form action = \"Product_Delete.php?product=$productid\" method = \"POST\">
            <div class = \"card shadow\">
                <div>
                    <img src = \"$productimg\" alt = \"Product1\" class = \"img-fluid card-img-top\">
                </div>
                <div class = \"card-body\">
                    ...
                    <button type = \"submit\" name = \"View\" class = \"btn btn-danger my-3\">Delete</button> 
                    <input type = \"hidden\" name = \"product_id\" value = \"$productid\">     
                </div>
            </div>
        </form>
